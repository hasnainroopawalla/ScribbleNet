...
def add_dims_to_array(image: np.ndarray) -> np.ndarray:
    ...
    """
    img_grayscale_channeled = np.expand_dims(image, axis=2) # Add last channel as 1 (28,28) to (28,28,1)
    return np.expand_dims(img_grayscale_channeled, axis=0) # Add frist channel to specify number of input images (1,28,28,1)
